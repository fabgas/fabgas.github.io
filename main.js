...
/* harmony import */ var _auth_component_login_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./auth/component/login.component */ "./src/app/auth/component/login.component.ts");
/* harmony import */ var _auth_guards_auth_guards__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./auth/_guards/auth.guards */ "./src/app/auth/_guards/auth.guards.ts");
...
var routes = [
    ...
    { path: 'login', component: _auth_component_login_component__WEBPACK_IMPORTED_MODULE_2__["LoginComponent"] },
    {
        path: 'home',
        loadChildren: './home/home.module#HomePageModule',
        canActivate: [_auth_guards_auth_guards__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    },
    {
        path: 'list',
    ...
    { path: 'process', loadChildren: './process/process.module#ProcessPageModule', canActivate: [_auth_guards_auth_guards__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]] },
    { path: 'detailprocess', loadChildren: './detailprocess/detailprocess.module#DetailprocessPageModule', canActivate: [_auth_guards_auth_guards__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]] },
...
/* harmony import */ var _auth_component_login_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./auth/component/login.component */ "./src/app/auth/component/login.component.ts");
/* harmony import */ var _app_routing_module__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./app-routing.module */ "./src/app/app-routing.module.ts");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm5/forms.js");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm5/http.js");
/* harmony import */ var _auth_helpers_error_interceptors__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./auth/_helpers/error.interceptors */ "./src/app/auth/_helpers/error.interceptors.ts");
/* harmony import */ var _auth_helpers_jwt_interceptors__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./auth/_helpers/jwt.interceptors */ "./src/app/auth/_helpers/jwt.interceptors.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            declarations: [_app_component__WEBPACK_IMPORTED_MODULE_6__["AppComponent"],
                _auth_component_login_component__WEBPACK_IMPORTED_MODULE_7__["LoginComponent"]],
            entryComponents: [],
            imports: [
            ...
            providers: [
                ...
                { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_10__["HTTP_INTERCEPTORS"], useClass: _auth_helpers_jwt_interceptors__WEBPACK_IMPORTED_MODULE_12__["JwtInterceptor"], multi: true },
                { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_10__["HTTP_INTERCEPTORS"], useClass: _auth_helpers_error_interceptors__WEBPACK_IMPORTED_MODULE_11__["ErrorInterceptor"], multi: true },
...
/***/ "./src/app/auth/_guards/auth.guards.ts":
/*!*********************************************!*\
  !*** ./src/app/auth/_guards/auth.guards.ts ***!
  \*********************************************/
...
/***/ "./src/app/auth/_helpers/error.interceptors.ts":
/*!*****************************************************!*\
  !*** ./src/app/auth/_helpers/error.interceptors.ts ***!
  \*****************************************************/
...
/***/ "./src/app/auth/_helpers/jwt.interceptors.ts":
/*!***************************************************!*\
  !*** ./src/app/auth/_helpers/jwt.interceptors.ts ***!
  \***************************************************/
...
/***/ "./src/app/auth/component/login.component.html":
/*!*****************************************************!*\
  !*** ./src/app/auth/component/login.component.html ***!
  \*****************************************************/
/*! no static exports found */
...
module.exports = "<ion-header>\r\n    <ion-toolbar color=\"primary\">\r\n\r\n        <ion-title>Login</ion-title>\r\n    </ion-toolbar>\r\n</ion-header>\r\n<ion-content padding>\r\n    <form [formGroup]=\"loginForm\" (ngSubmit)=\"onSubmit()\">\r\n        <ion-item>\r\n            <ion-input placeholder=\"Username\" required type=\"text\" formControlName=\"username\"></ion-input>\r\n        </ion-item>\r\n        <ion-item>\r\n            <ion-input placeholder=\"Password\" required type=\"password\" formControlName=\"password\"></ion-input>\r\n        </ion-item>\r\n        <ion-button type=\"submit\" color=\"primary\">Success</ion-button>\r\n    </form>\r\n</ion-content>"

/***/ }),

/***/ "./src/app/auth/component/login.component.ts":
/*!***************************************************!*\
  !*** ./src/app/auth/component/login.component.ts ***!
  \***************************************************/
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({ template: __webpack_require__(/*! ./login.component.html */ "./src/app/auth/component/login.component.html") }),
...
module.exports = __webpack_require__(/*! Z:\Projets\Angular\Ionic\intraDay2\src\main.ts */"./src/main.ts");
